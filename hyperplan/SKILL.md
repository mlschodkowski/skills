...
Find blockers before code. Review the proposed solution; do not invent a different product. Do not write implementation code before the review is complete.
