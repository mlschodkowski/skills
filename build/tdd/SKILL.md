...
boundary requires it. See [mocking.md](mocking.md) when the mock
boundary is unclear. See [tests.md](tests.md) when a test is drifting
...
2. **Green.** Write the smallest implementation that passes. Do not add
   speculative options, abstractions, or unrelated cleanup.
