...
Hunt accidental complexity — structure with no job. Keep what the
problem actually requires. Abstractions earn existence or they go.
Shortest wrong is still wrong; do not cut validation, failure behavior,
or operability to look lean.
