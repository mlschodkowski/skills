---
name: git-commit
description: 'Use when the user asks to commit changes, create a Git commit, or mentions "/commit"; stage files by scope and write a scoped commit message with an optional plain description.'
license: MIT
allowed-tools: Bash
---
...
Write the subject and body in plain, precise language. Keep scoped-commit
syntax and repository terms exact. Prefer what a later reader needs to
know over decorative detail.
