...
Structure the record around the decision itself: context, options,
choice, and consequences. Prefer the repository's ADR template and
established terms over a generic format. Keep wording precise and plain;
do not pad sections that have no job.
