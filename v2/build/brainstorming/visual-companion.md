...
by reading it. Form follows the decision: show only what changes the
choice.
...
Scale fidelity to the question — enough to expose the real difference,
nothing decorative. Put the question on the page. Two to four options.
Use real content when placeholder content would hide the issue.
