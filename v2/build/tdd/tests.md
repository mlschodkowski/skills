...
survive an internal refactor — optimize for repeated use and change,
not for inspecting private structure.
...
interface — keep the contract legible; do not hide the relationship
behind a side channel.
